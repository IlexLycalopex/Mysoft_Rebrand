  ...
  solutions: {
    ...
    cols: [
      ...
      { t: "By Sector", l: [
        ...
        { name: "Food & Beverage",              sub: "FEFO, traceability, compliance" },
        { name: "Professional Services & SaaS", sub: "Project accounting, revenue recognition" },
        { name: "Not-for-Profit & Healthcare",  sub: "Fund accounting, SORP compliance" },
        { name: "Financial Services",           sub: "Multi-entity, regulated environments" },
      ]},
    ],
  },
  insights: {
